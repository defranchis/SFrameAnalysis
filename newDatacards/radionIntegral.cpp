...
int main ( int argc, char * argv[] ){
    ...
    for (unsigned int iSample = 0; iSample < sampleList.size(); ++iSample)
    {
        ...
        double integratedLuminosity = 36.22;   // in fb^-1
        ...
        if (sampleName.Contains("M-1000")) mass = 1000 ;
        if (sampleName.Contains("M-1200")) mass = 1200 ;
        if (sampleName.Contains("M-1400")) mass = 1400 ;
        if (sampleName.Contains("M-1600")) mass = 1600 ;
        if (sampleName.Contains("M-1800")) mass = 1800 ;
        if (sampleName.Contains("M-2000")) mass = 2000 ;
        if (sampleName.Contains("M-2500")) mass = 2500 ;
        if (sampleName.Contains("M-3000")) mass = 3000 ;
        if (sampleName.Contains("M-3500")) mass = 3500 ;
        if (sampleName.Contains("M-4000")) mass = 4000 ;
        if (sampleName.Contains("M-4500")) mass = 4500 ;
        ...
        int iMin = h_temp->FindBin(mass*.85);
        int iMax = h_temp->FindBin(mass*1.15);
        
        if (mass >= 3000){
            iMin = h_temp->FindBin(3000*.85);
            iMax = h_temp->FindBin(4500*1.15);
        }
        ...
        outTxt<<signalIntegral<<"\t"<<err_signalIntegral<<endl;
