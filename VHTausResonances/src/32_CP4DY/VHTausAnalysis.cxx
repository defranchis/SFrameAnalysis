...

{
    ...
    DeclareProperty( "tautauMassMax",            m_tautauMassMax         = 110.);
...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for ( unsigned int i = 0; i<tau_TLV.size(); ++i )
    {
        ...
        if (tau_TLV[i].Pt() > 1500 ) continue; //comment out later
        ...
        goodTau_TightIso.push_back(tau_TightIso[i]) ;
    ...
    // bool jetSidebandMassWindow = (jetPrunedMass > m_jetSidebandMassMin) && (jetPrunedMass < m_jetSidebandMassMax);
...
// ////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if ( (sumPT < m_tautauPtCut) || (resonanceMass < m_tautauJetMassMin)
        ...
        return;
    if ( (tau1_TLV_sel.Pt() > 1500.) || (tau2_TLV_sel.Pt() > 1500.) )
...

    {
        ...
        bool isTauIso_Tight_1 = goodTau_TightIso[iTau_sel];
        bool isTauIso_Tight_2 = goodTau_TightIso[jTau_sel];
...
void VHTausAnalysis::createTemplates (){
    ...
    for ( int i = 0; i<(m_tau.N); ++i )
    {
        ...
        if (isTauBoosted){
            ...
            tau_TightIso.push_back(mytau.byTightIsolationMVArun2v1PWnewDMwLT());
