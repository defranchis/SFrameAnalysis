...

{
    ...
    // turnon_fit_HT900 = new TFile("~/HH/8_X_Framework/Analysis/SFrameAnalysis/VHTausResonances/trigger_turnon/turnOn_fit.root");
    // trig_eff_HT900 = (TF1*) turnon_fit_HT900->GetObjectChecked("turn_on","TF1");


    trig_turnon_eff_HT900 = new TFile("~/HH/8_X_Framework/Analysis/SFrameAnalysis/VHTausResonances/trigger_turnon/singleMuon.root");
    trig_eff_HT900 = (TEfficiency*) trig_turnon_eff_HT900->GetObjectChecked("trigger_eff_vs_HT/eff_HT_coarse","TEfficiency");
...
void VHTausAnalysis::applyTurnOn (){
    ...
    double HT_4eff = event_HT;
    if ( HT_4eff > 1100. ) HT_4eff = 1100. ;
    
    // b_weight *= trig_eff_HT900->Eval( HT_4eff );

    b_weight *= trig_eff_HT900->GetEfficiency(trig_eff_HT900->FindFixBin(HT_4eff));

    // std::cout<<trig_eff_HT900->GetEfficiency(trig_eff_HT900->FindFixBin(HT_4eff))<<std::endl;
