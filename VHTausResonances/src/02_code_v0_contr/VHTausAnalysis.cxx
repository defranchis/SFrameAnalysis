...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("factor_a","factor_a ; _a",100,0,30), directory);
    Book ( TH1F("factor_b","factor_b ; _b",100,0,30), directory);
...

{
    ...
    Hist( "factor_a", directory )->Fill(a); 
    Hist( "factor_b", directory )->Fill(b);
