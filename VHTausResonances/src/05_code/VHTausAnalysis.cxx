...
////////////////////////////////////////////////////////////////////////////////////////////
            ...
            float deltaPhi_tauMET = fabs(v2_taus.DeltaPhi(v2_met));
            double deltaR_tautau = tau1_TLV_sel.DeltaR(tau2_TLV_sel);
            double deltaR_tautaujet = sumTau_TLV_sel.DeltaR(jetAK08TLV_sel);

            // cout<<"***"<<endl;
            // cout<<"delta phi = "<<deltaPhi_tauMET<<endl;
            // cout<<"DR tautau = "<<deltaR_tautau<<endl;
            // cout<<"DR taujet = "<<deltaR_tautaujet<<endl;
            // cout<<"***"<<endl;

            if ( (deltaPhi_tauMET > m_tautauMetDeltaPhiMax) || (deltaR_tautau > m_tautauDRMax) || (deltaR_tautaujet < m_tautauJetDRMin) )
                return;

            // cout<<"passed taus 1"<<endl;
