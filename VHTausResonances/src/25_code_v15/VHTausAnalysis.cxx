...
void VHTausAnalysis::applyTurnOn (){
    ...
    if (event_HT<1500.){
        ...
        // if ( do_turnon_shift == 0 ) trigger_factor = trig_eff->GetEfficiency(trig_eff->FindFixBin(event_HT));
        // else if ( do_turnon_shift == 1 ) trigger_factor = trig_eff->GetEfficiency(trig_eff->FindFixBin(event_HT)) + 
        ...
        double factor_800 = trig_eff_HT800->GetEfficiency(trig_eff_HT800->FindFixBin(event_HT));
        double factor_900 = trig_eff_HT900->GetEfficiency(trig_eff_HT900->FindFixBin(event_HT));
        ...
        cout<<factor_800<<"\t"<<factor_900<<"\t"<<trigger_factor<<endl;
