...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for (unsigned int i = 0; i < jetAK8_TLV.size(); ++i ) 
    {
        ...
        if (passCuts && isJetID)
        {
            ...
            goodAK8_nbHadrons.push_back(jetAK8_nbHadrons[i]);
        }
    ...
    for (unsigned int i = 0; i < goodAK8_TLV.size(); ++i) 
    {
        ...
        if ( (goodAK8_TLV[i].Pt() > goodAK08TLV_sel.Pt()) && isMetAngle)
        {
            ...
            sel_nbHadrons = goodAK8_nbHadrons[i];
        }
    }
...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("n_bHadrons","truth number of b hadrons;n. B-hadrons",4,-.5,3.5), directory);
...

{
    ...
    Hist( "n_bHadrons", directory )->Fill( sel_nbHadrons , b_weight );
...
void VHTausAnalysis::createTemplates (){
    ...
    for ( int i = 0; i < (m_jetAK8.N); ++i )     
    {
        ...
        //if (!m_isData) std::cout<<recoJet.nbHadrons()<<std::endl;
        if (!m_isData) jetAK8_nbHadrons.push_back(recoJet.nbHadrons());
