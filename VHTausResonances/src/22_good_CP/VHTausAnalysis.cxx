...

{
    ...
    // DeclareProperty( "jetHbbtagMin",             m_jetHbbtagMin       = -0.5  );
    // DeclareProperty( "jetHbbtagMin",             m_jetHbbtagMin       = -3.  );
    DeclareProperty( "jetHbbtagMin",             m_jetHbbtagMin       = -.45  );
    ...
    DeclareProperty( "jetMassMax",               m_jetMassMax         = 1.E06 );
    ...
    DeclareProperty( "tautauMassMax",            m_tautauMassMax         = 1.E06);
