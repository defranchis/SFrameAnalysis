...
void VHTausAnalysis::ExecuteEvent( const SInputData&, Double_t ) throw( SError ) 
{
    ...
    n_isoMuons = isoMuons.size();
    n_isoElectrons = isoElectrons.size();
...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("n_muons","number of muons;n. taus",16,-.5,15.5), directory);
    Book ( TH1F("n_electrons","number of electrons;n. taus",16,-.5,15.5), directory);
...

{
    ...
    Hist( "n_muons", directory )->Fill( n_isoMuons , b_weight );
    Hist( "n_electrons", directory )->Fill( n_isoElectrons , b_weight );
