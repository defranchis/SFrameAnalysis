...

{
   ...
   // DeclareProperty( "JSONName",                 m_jsonName             = std::string (std::getenv("SFRAME_DIR")) + "/../GoodRunsLists/JSON/Cert_271036-277148_13TeV_PromptReco_Collisions16_JSON_NoL1T.txt" );
    ...
    trig_turnon_eff_HT = new TFile("~/HH/8_X_Framework/Analysis/SFrameAnalysis/VHTausResonances/trigger_turnon/trigger_HT.root");
    // trig_turnon_eff_HT = new TFile("~/HH/8_X_Framework/Analysis/SFrameAnalysis/VHTausResonances/trigger_turnon/turnonHT900.root");
