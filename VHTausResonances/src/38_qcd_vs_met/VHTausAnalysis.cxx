...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("resMass_met10","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
    Book ( TH1F("resMass_met20","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
    Book ( TH1F("resMass_met30","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
    Book ( TH1F("resMass_met40","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
    Book ( TH1F("resMass_met50","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
    Book ( TH1F("resMass_met60","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
    Book ( TH1F("resMass_met70","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
    Book ( TH1F("resMass_met80","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
    Book ( TH1F("resMass_met90","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
    Book ( TH1F("resMass_met100","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
    Book ( TH1F("resMass_met110","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
    Book ( TH1F("resMass_met120","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",30,0,3000), directory);
...

{
    ...
    for (float met_cut = 10.; met_cut <= 120.; met_cut += 10.){

        int int_cut = (int) met_cut;
        TString hName = "resMass_met";
        TString hNumb; hNumb.Form("%d",int_cut);
                           
        if (met_et > met_cut) Hist( hName+hNumb , directory )->Fill(tauJetMass, b_weight );        
