...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //fillHistograms(m_catNames[n_lepW], selectedJet, selectedTau_1, selectedTau_2, goodMet, sumTauTLV_sel, sumAllTLV_sel);
    fillHistograms(m_catNames[n_lepW], selectedJet, selectedTau_1, selectedTau_2, goodMet, 
                   sumTauTLV_sel, sumAllTLV_sel, selectedMuon, selectedElectron);
...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("h_electrons","number of electrons ; n. electrons",6,-.5,5.5), directory);
    Book ( TH1F("h_muons","number of muons ; n. muons",6,-.5,5.5), directory);

    Book ( TH1F("muon_pT"," muon pT ; muon p_{T} [GeV]",50,0,500), directory);
    Book ( TH1F("electron_pT"," electron pT ; electron p_{T} [GeV]",50,0,500), directory);
    Book ( TH1F("muon_Iso"," muon isolation ; iso/pt [GeV^{-1}]",50,0,1), directory);
    Book ( TH1F("muon_Iso_thick"," muon isolation ; iso/pt [GeV^{-1}]",100,0,1), directory);
