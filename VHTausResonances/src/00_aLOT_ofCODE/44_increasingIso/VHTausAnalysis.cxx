...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for ( int i = 0; i<(m_tau.N); ++i )
    {
        ...
        bool isTauIso_custom = mytau.byIsolationMVA3newDMwLTraw() > -.4;

        if (passCuts && isTauDM && isTauBoosted /*&& isTauIso*/ && isTauIso_custom && againstElectron && againstMuon)
