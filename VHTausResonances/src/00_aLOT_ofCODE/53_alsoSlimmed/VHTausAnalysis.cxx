...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //std::cout<<goodSlimmed.size()<<"\t"<<goodTaus.size()<<std::endl;
    ...
    if (!foundTauPair)
    {
        ...
        for (unsigned int iTau=0; iTau<goodSlimmed.size(); ++iTau)
            ...
            for (unsigned int jTau=iTau+1; jTau<goodSlimmed.size(); ++jTau)
            {
                ...
                tau1_TLV.SetPtEtaPhiE( goodSlimmed.at(iTau).pt(), goodSlimmed.at(iTau).eta(), goodSlimmed.at(iTau).phi() ,goodSlimmed.at(iTau).e() );
                tau2_TLV.SetPtEtaPhiE( goodSlimmed.at(jTau).pt(), goodSlimmed.at(jTau).eta(), goodSlimmed.at(jTau).phi() ,goodSlimmed.at(jTau).e() );
                ...
                if ( deltaPhi < m_tautauMetDeltaPhiMax )
                {
                    ...
                    if ( (py2*px1 - px2*py1) != 0 && (px1 != 0) )
                    {
...

                        {
                            ...
                            std::cout<<"maybe found sth..."<<std::endl;
