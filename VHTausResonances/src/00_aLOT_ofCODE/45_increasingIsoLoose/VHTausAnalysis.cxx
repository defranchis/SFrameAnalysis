...
/*
  ...
  VERY LOOSE SELECTIONS IN B-TAGGED REGION
  INCREASING TAU ISOLATION (CUSTOMIZED)
...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for ( int i = 0; i<(m_tau.N); ++i )
    {
        ...
        bool isTauIso_custom = mytau.byIsolationMVA3newDMwLTraw() > -1.;

        if (passCuts && isTauDM /*&& isTauIso*/ && isTauIso_custom && isTauBoosted && againstElectron && againstMuon)
