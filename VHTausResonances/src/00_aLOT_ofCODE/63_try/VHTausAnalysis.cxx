...

{
    ...
    DeclareProperty( "IsBtagSR",                 is_btag_SR                 = false );
    DeclareProperty( "IsTauIsoSR",               is_tauiso_SR               = false );
...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    bool foundJet = false;
    {
        ...
        TVector2 v2_jet (jetAK08TLV_sel.Px(), jetAK08TLV_sel.Py());
        TVector2 v2_met (met_px, met_py);
        double deltaPhi = fabs( v2_jet.DeltaPhi(v2_met) );
        double prunedMass = selectedJet.pruned_massCorr();
        ...
        if (massWindow && isHbbtag && isMetAngle)
            foundJet = true;
...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for ( int i = 0; i<(m_tau.N); ++i )
    {
        ...
        if (passCuts && isTauDM && isTauBoosted && againstElectron && againstMuon)
    ...
    if ((iTau_sel < 0) || (jTau_sel < 0) ) return;
    ...
    
    {
        ...
        tau1_TLV.SetPtEtaPhiE( selectedTau_1.pt(), selectedTau_1.eta(), selectedTau_1.phi() ,selectedTau_1.e() );
        tau2_TLV.SetPtEtaPhiE( selectedTau_2.pt(), selectedTau_2.eta(), selectedTau_2.phi() ,selectedTau_2.e() );
        sumTLV = tau1_TLV + tau2_TLV ;
        double sumPT = sumTLV.Pt();
        ...
        if ( deltaPhi < m_tautauMetDeltaPhiMax )
        {
            ...
            if ( (py2*px1 - px2*py1) != 0 && (px1 != 0) )
            {
                ...
                if ( (sumPT > m_tautauPtCut) && (deltaR_tautau < m_tautauDRMax)
