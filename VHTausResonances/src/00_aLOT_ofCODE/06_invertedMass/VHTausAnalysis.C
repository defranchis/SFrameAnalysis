...
/*
  FULL SELECTIONS - INVERTED JET MASS WINDOW
*/
...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for ( int i = 0; i < (m_jetAK8.N); ++i ) 
    {
        ...
        bool massWindow = (prunedMass > 50.) && (prunedMass < m_jetMassMin);
...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("jet_tau21","Hbb jet subjettiness ratio tau21; #tau21",25,0,1.5), directory);
    ...
    Book ( TH1F("tautau_mass","tau pair invariant mass (coll. nu);m(#tau,#tau) (GeV)",30,0,200), directory);
