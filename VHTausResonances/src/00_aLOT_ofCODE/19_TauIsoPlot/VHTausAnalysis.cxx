...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for (unsigned int iTau=0; iTau<goodTaus.size(); ++iTau)
        ...
        for (unsigned int jTau=iTau+1; jTau<goodTaus.size(); ++jTau)
        {
            ...
            if ( (sumPT >= sumPT_leading) /*&& (deltaR_tautau < m_tautauDRMax) && (deltaR_tautaujet > m_tautauJetDRMin)*/ ) 
    ...
    if ( (py2*px1 - px2*py1) != 0 && (px1 != 0) ) 
    {
        ...
        tau1_TLV_sel *= (1+a) ;
        tau2_TLV_sel *= (1+b) ;
        sumTauTLV_sel = tau1_TLV_sel + tau2_TLV_sel ;
...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("tau1_iso","leading tau isolation;MVA output",44,-1.1,1.1), directory);
    Book ( TH1F("tau2_iso","leading tau isolation;MVA output",44,-1.1,1.1), directory);
