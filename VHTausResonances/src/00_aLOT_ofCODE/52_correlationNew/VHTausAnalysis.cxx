...
/*
  ...
  CORRELATION BETWEEN BTAG AND ISOLATION
...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH2F("tauIso_vs_Hbbtag_1_i","leading tau isolation vs double b tagger;Hbbtag;tauIso",10,-1,1,10,-1,1), directory);
    Book ( TH2F("tauIso_vs_Hbbtag_2_i","trailing tau isolation vs double b tagger;Hbbtag;tauIso",10,-1,1,10,-1,1), directory);

    Book ( TH2F("tauIso_vs_Hbbtag_1_ii","leading tau isolation vs double b tagger;Hbbtag;tauIso",20,-1,1,20,-1,1), directory);
    Book ( TH2F("tauIso_vs_Hbbtag_2_ii","trailing tau isolation vs double b tagger;Hbbtag;tauIso",20,-1,1,20,-1,1), directory);

    Book ( TH2F("tauIso_vs_Hbbtag_1_iii","leading tau isolation vs double b tagger;Hbbtag;tauIso",50,-1,1,50,-1,1), directory);
    Book ( TH2F("tauIso_vs_Hbbtag_2_iii","trailing tau isolation vs double b tagger;Hbbtag;tauIso",50,-1,1,50,-1,1), directory);

    Book ( TH2F("tauIso_vs_Hbbtag_1_iv","leading tau isolation vs double b tagger;Hbbtag;tauIso",100,-1,1,100,-1,1), directory);
    Book ( TH2F("tauIso_vs_Hbbtag_2_iv","trailing tau isolation vs double b tagger;Hbbtag;tauIso",100,-1,1,100,-1,1), directory);


    Book ( TH2F("tauIso_vs_Hbbtag_1_pt500_650","trailing tau isolation vs double b tagger;Hbbtag;tauIso",100,-1,1,100,-1,1), directory);
    Book ( TH2F("tauIso_vs_Hbbtag_1_pt650_Inf","trailing tau isolation vs double b tagger;Hbbtag;tauIso",100,-1,1,100,-1,1), directory);
    Book ( TH2F("tauIso_vs_Hbbtag_2_pt500_650","trailing tau isolation vs double b tagger;Hbbtag;tauIso",100,-1,1,100,-1,1), directory);
    Book ( TH2F("tauIso_vs_Hbbtag_2_pt650_Inf","trailing tau isolation vs double b tagger;Hbbtag;tauIso",100,-1,1,100,-1,1), directory);
                                    ...
                                    TLorentzVector sumTau, TLorentzVector sumAll)
{
    ...
    Retrieve<TH2F>("tauIso_vs_Hbbtag_1_i", directory )->Fill(Jet.Hbbtag(),Tau1.byIsolationMVA3newDMwLTraw(), b_weight);
    Retrieve<TH2F>("tauIso_vs_Hbbtag_2_i", directory )->Fill(Jet.Hbbtag(),Tau2.byIsolationMVA3newDMwLTraw(), b_weight);

    Retrieve<TH2F>("tauIso_vs_Hbbtag_1_ii", directory )->Fill(Jet.Hbbtag(),Tau1.byIsolationMVA3newDMwLTraw(), b_weight);
    Retrieve<TH2F>("tauIso_vs_Hbbtag_2_ii", directory )->Fill(Jet.Hbbtag(),Tau2.byIsolationMVA3newDMwLTraw(), b_weight);

    Retrieve<TH2F>("tauIso_vs_Hbbtag_1_iii", directory )->Fill(Jet.Hbbtag(),Tau1.byIsolationMVA3newDMwLTraw(), b_weight);
    Retrieve<TH2F>("tauIso_vs_Hbbtag_2_iii", directory )->Fill(Jet.Hbbtag(),Tau2.byIsolationMVA3newDMwLTraw(), b_weight);

    Retrieve<TH2F>("tauIso_vs_Hbbtag_1_iv", directory )->Fill(Jet.Hbbtag(),Tau1.byIsolationMVA3newDMwLTraw(), b_weight);
    Retrieve<TH2F>("tauIso_vs_Hbbtag_2_iv", directory )->Fill(Jet.Hbbtag(),Tau2.byIsolationMVA3newDMwLTraw(), b_weight);


    if (Jet.pt()<650){
        Retrieve<TH2F>("tauIso_vs_Hbbtag_1_pt500_650", directory )->Fill(Jet.Hbbtag(),Tau1.byIsolationMVA3newDMwLTraw(), b_weight);
        Retrieve<TH2F>("tauIso_vs_Hbbtag_2_pt500_650", directory )->Fill(Jet.Hbbtag(),Tau2.byIsolationMVA3newDMwLTraw(), b_weight);
    }

    else{
        Retrieve<TH2F>("tauIso_vs_Hbbtag_1_pt650_Inf", directory )->Fill(Jet.Hbbtag(),Tau1.byIsolationMVA3newDMwLTraw(), b_weight);
        Retrieve<TH2F>("tauIso_vs_Hbbtag_2_pt650_Inf", directory )->Fill(Jet.Hbbtag(),Tau2.byIsolationMVA3newDMwLTraw(), b_weight);
    }
