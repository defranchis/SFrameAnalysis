...
// ////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // bool acceptTaus = ( (deltaR_tautau_sel < m_tautauDRMax)  && (deltaR_tautaujet_sel > m_tautauJetDRMin) && (tautau_met_deltaPhi_sel < m_tautauMetDeltaPhiMax) );
    // if (!acceptTaus) return;
...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("n_AK04_jets","number of AK04 jets;n. AK04 jets",16,-.5,15.5), directory);
    ...
    Book ( TH1F("corrected_tau1_pT","leading tau pT;leading tau p_{T} [GeV]",30,0,3000), directory);
    ...
    Book ( TH1F("corrected_tau2_pT","sub-leading tau pT;sub-leading tau p_{T} [GeV]",30,0,2000), directory);
    ...
    Book ( TH1F("original_tautau_jet_DR","tautau-jet distance ;#DeltaR (#tau#tau,jet) ",30,0,6), directory);
    Book ( TH1F("original_tau_tau_DR","tau pair distance;#DeltaR (#tau,#tau)",30,0,2), directory);
    ...
    Book ( TH1F("corrected_tautau_jet_DR","tautau-jet distance ;#DeltaR (#tau#tau,jet) ",30,0,6), directory);
    Book ( TH1F("corrected_tau_tau_DR","tau pair distance;#DeltaR (#tau,#tau)",30,0,2), directory);
    ...
    Book ( TH1F("original_tautau_mass","tau pair invariant mass ; mass (#tau,#tau) [GeV]",30,0,250), directory);    
    Book ( TH1F("corrected_tautau_mass","tau pair invariant mass ; mass (#tau,#tau) [GeV]",30,0,250), directory);    
    Book ( TH1F("raw_tautau_jet_mass","tautau-jet invariant mass;mass (#tau#tau,jet) [GeV]",70,0,7000), directory);
    Book ( TH1F("resonance_mass","resonance invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",70,0,7000), directory);
    Book ( TH1F("resonance_mass_bin","resonance invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",700,0,7000), directory);
