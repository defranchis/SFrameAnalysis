...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("n_PV","number of primary vertices;n. of Primary Vertices",31,-.5,30.5), directory);
    ...
    Book ( TH1F("orig_tau1_pT","leading tau pT;leading tau p_{T} [GeV]",30,0,2000), directory);
    Book ( TH1F("orig_tau2_pT","sub-leading tau pT;sub-leading tau p_{T} [GeV]",30,0,700), directory);
...

{
    ...
    Hist( "orig_tau1_pT", directory )->Fill( original_tau_pt_1 , b_weight);
    Hist( "orig_tau2_pT", directory )->Fill( original_tau_pt_2 , b_weight);
...
void VHTausAnalysis::createTemplates (){
    ...
    for ( int i = 0; i<(m_tau.N); ++i )
    {
        ...
        tau_VLooseIso.push_back(mytau.byVLooseIsolationMVA3newDMwLT());
        tau_LooseIso.push_back(mytau.byLooseIsolationMVA3newDMwLT());
        tau_rawIso.push_back(mytau.byIsolationMVA3newDMwLTraw());
