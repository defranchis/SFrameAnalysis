...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    bool jetMassWindow = (jetPrunedMass > 50. );
...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("jet_mass","jet pruned mass (with JEC);jet pruned mass [GeV]",60,0,300), directory);
    ...
    Book ( TH1F("nPV","number of primary vertices;n. of primary vertices",51,-.5,50.5), directory);
                                    ...
                                    TLorentzVector sumTau, TLorentzVector sumAll)
{
    ...
    std::cout<<m_eventInfo.PV_N<<std::endl;
    Hist( "nPV", directory )->Fill(m_eventInfo.PV_N,b_weight);
