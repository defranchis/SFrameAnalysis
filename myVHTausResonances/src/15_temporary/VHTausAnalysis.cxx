...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // if ( (sumPT < m_tautauPtCut) || (resonanceMass > 800.) || (resonanceMass < 500.)
    //      || (tautauMass < m_tautauMassMin) || (tautauMass > m_tautauMassMax) )

    if ( (sumPT < m_tautauPtCut) || (tautauMass < 10) )
...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("resonance_mass","tautau-jet invariant mass (coll. nu);mass (#tau#tau,jet) [GeV]",140,0,7000), directory);
