...
void VHTausAnalysis::BeginCycle() throw( SError ) {
    ...
    m_catNames.push_back("undefined");
...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (is_btag_SR && is_tauiso_SR)
        fillHistograms(m_catNames[n_lepTaus+1], selectedJet, selectedTau_1, selectedTau_2, goodMet, sumTau_TLV_sel, sumAll_TLV_sel);
