...
void VHTausAnalysis::bookHistograms( const TString& directory ) {
    ...
    Book ( TH1F("n_AK04_jets","number of AK04 jets;n. AK04 jets",11,-.5,10.5), directory);
    Book ( TH1F("n_AK08_jets","number of AK08 jets;n. AK08 jets",11,-.5,10.5), directory);
    // Book ( TH1F("n_muons","number of muons;n. muons",11,-.5,10.5), directory);
    // Book ( TH1F("n_electrons","number of electrons;n. electrons",11,-.5,10.5), directory);
    Book ( TH1F("n_taus","number of taus;n. taus",11,-.5,10.5), directory);
