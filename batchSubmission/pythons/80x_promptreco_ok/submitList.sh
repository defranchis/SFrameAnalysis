...
python -u submitSFrame.py -j ./pythons/TTJets.py --nosandbox --useEnv & 
sleep 30
...
sleep 100
python -u submitSFrame.py -j ./pythons/WJetsToLNu.py --nosandbox --useEnv & 
python -u submitSFrame.py -j ./pythons/WJetsToQQ.py --nosandbox --useEnv & 
sleep 50
